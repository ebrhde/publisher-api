 ...
 */
final class Version20221205123151 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book ADD slug VARCHAR(255) NOT NULL, ADD image VARCHAR(255) NOT NULL, ADD authors LONGTEXT NOT NULL COMMENT \'(DC2Type:simple_array)\', ADD publication_date DATE NOT NULL, ADD meap TINYINT(1) DEFAULT false NOT NULL');
    }
